...
ttk.Label(frame, text="Dilution Factor").grid(row=6, column=0)
dilution_entry = ttk.Entry(frame)
dilution_entry.grid(row=6, column=1)
dilution_entry.insert(0, "10")

ttk.Label(frame, text="Total Cells Per UWell").grid(row=7, column=0)
total_cells_per_uwell_entry = ttk.Entry(frame)
total_cells_per_uwell_entry.grid(row=7, column=1)
total_cells_per_uwell_entry.insert(0, "120")

ttk.Label(frame, text="Number of Wells").grid(row=8, column=0)
num_of_wells_entry = ttk.Entry(frame)
num_of_wells_entry.grid(row=8, column=1)
num_of_wells_entry.insert(0, "24")

ttk.Label(frame, text="Micro wells per wells").grid(row=9, column=0)
uwell_per_well_entry = ttk.Entry(frame)
uwell_per_well_entry.grid(row=9, column=1)
uwell_per_well_entry.insert(0, "1200")

ttk.Label(frame, text="Well's volume").grid(row=10, column=0)
